...
`iccScan` is a mashup of [LittleCMS 2.16](https://www.littlecms.com/) and [ICC.1:2024-05 (iccMAX 2.3.1)](https://www.color.org/specification/ICC_Max.xalter), designed to demonstrate a measurement and analysis toolchain for ICC profiles.
...
./licc -v 1 ../../../../UnitTest/cve-2023-46602.icc
```
...
l'icc Profile Scanner [LittleCMS 2.16, IccProfLib 2.3.1, IccLibXML 2.3.1]
